...
public class ModEntities {
    ...
    public static final EntityType<NonVecScalingArrow> NON_VEC_SCALING_ARROW = Registry.register(
            Registries.ENTITY_TYPE, CardsNCrossbowsMain.id("non_vec_scaling_arrow"),
            FabricEntityTypeBuilder.<NonVecScalingArrow>create(SpawnGroup.MISC, NonVecScalingArrow::new)
                    .dimensions(EntityDimensions.fixed(0.5f, 0.5f))
                    .trackedUpdateRate(10)
                    .trackRangeBlocks(4)
                    .build()
